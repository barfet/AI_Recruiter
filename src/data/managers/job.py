...
from src.data.models.base import JobPosting
from src.data.managers.base import BaseManager
from src.core.config import JOB_POSTINGS_DIR
...
class JobManager(BaseManager):
    ...
    def __init__(self):
        ...
        self.companies_dir = JOB_POSTINGS_DIR / "companies"
        self.jobs_dir = JOB_POSTINGS_DIR / "jobs"
        self.mappings_dir = JOB_POSTINGS_DIR / "mappings"
        self.postings_file = JOB_POSTINGS_DIR / "postings.csv"
